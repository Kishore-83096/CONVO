PARROT IDENTITY API DOCUMENTATION
=================================

This document describes every HTTP API exposed by the Parrot Identity service
...
|---|---|---|
| `base_url` | `http://127.0.0.1:5000` | Local Parrot Identity service |
...
| `app/contacts` | `/api/v1/contacts` | Search Parrot users, save contacts, list contacts, view details, rename, and delete |
...
user's Parrot email and 10-digit contact number. Login creates a 24-hour access
...
```json
{
  ...
  "data": {
    "url": "https://res.cloudinary.com/example/image/upload/v1/parrotv2/local/profiles/ada_lovelace.png",
    "format": "png",
    "width": 512,
    "height": 512,
    "bytes": 84521,
...
contact must reference another active Parrot user. Searching by the logged-in
...
```json
{
  ...
  "data": {
    ...
    "profile_picture": {
      "url": "https://res.cloudinary.com/example/image/upload/v1/parrotv2/local/profiles/alan_turing.png",
      "format": "png",
      "width": 512,
      "height": 512,
      "bytes": 84521,
...
{
  "success": true,
  "message": "Parrot Identity service is running.",
  "data": {
    "component": "service",
    "status": "up",
    "message": "Parrot Identity service is running.",
