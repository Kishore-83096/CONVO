    ...
    try {
      ...
      setErrorMessage(
        error instanceof ApiClientError || error instanceof Error
          ? error.message
          : "Unable to check the Myna Identity service.",
      )
    }
  }, [])
  ...
  return (
    <main className="app-shell">
      <SeoMeta
        ...
        description="Myna private health check page."
        robots="noindex, nofollow"
        title="Myna Health Check"
      />
      <section className="status-page" aria-labelledby="page-title">
        ...
        <div className="intro">
          ...
          <p>
            Live connectivity check between this frontend and the Myna
            Identity API.
          </p>
        </div>
        ...
        >
          <div className="health-card__header">
            ...
            <div className="status-copy">
              ...
              <h2>
                {requestStatus === "loading"
                  ? "Contacting Myna Identity..."
                  : isConnected
                    ? "Myna Identity is available"
                    : "Myna Identity is unavailable"}
              </h2>
              <p>
                {requestStatus === "loading"
