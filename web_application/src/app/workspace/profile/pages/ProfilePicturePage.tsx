...
import ImageCropper from "@/app/workspace/shared/components/ImageCropper"
  ...
  return (
    <section className="workspace-panel active">
      ...
      <ConfirmActionModal
        ...
        description="This will remove your current profile picture from Myna. You can upload a new one later."
        isBusy={isSubmitting}
