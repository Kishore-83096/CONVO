...
class Command(BaseCommand):
    help = (
        "Expire completed encrypted attachments that were never attached "
        "to a message after a safe grace period."
    )
    ...
    def add_arguments(self, parser):
        parser.add_argument(
            ...
            default=None,
            help=(
                "Expire completed unattached attachments older than this many "
                "hours. Defaults to ATTACHMENT_UNATTACHED_GRACE_HOURS."
            ),
        )
        parser.add_argument(
            "--limit",
    ...
    def handle(self, *args, **options):
        ...
        queryset = (
            EncryptedAttachment.objects.filter(
                ...
                attached_message__isnull=True,
                attached_room__isnull=True,
        ...
        for attachment in queryset:
            ...
            attachment.expires_at = attachment.expires_at or now
        ...
        self.stdout.write(
            self.style.SUCCESS(
                "cleanup_unattached_completed_attachments complete: "
